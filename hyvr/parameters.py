...
def model_setup(pf, nodir=False):
    ...
    """
    run, mod, strata, hydraulics, flowtrans, elements = parameters(pf, nodir=nodir)
...
def parameters(inifile, nodir=False):
    """
